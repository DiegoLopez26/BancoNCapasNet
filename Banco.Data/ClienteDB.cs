        ...
        public int Insertar(Cliente cliente)
        {
            ...
            using (var conexion = new SqlConnection(UtilDB.CadenaConexion()))
            {
                ...
                var query = "Insert into [dbo].[Cliente]" +
                    "([Nombres],[Apellidos],[RazonSocial],[NumeroDoc]," +
                    "[IdTipoDoc],[IdTipoCliente],[direccion] ,[Referencia] ,[Telefono] ,[Email])" +
                    "VALUES(@Nombres,@Apellidos,@RazonSocial,@NumeroDoc,@IdTipoDoc,@IdTipoCliente,@direccion,@Referencia,@Telefono,@Email";
